...
def generate_receipt_file(cash, change, invoice_no, total, summary, mode="counter"):
    ...
    # 1. Calculate Total Profit from the summary data
    # Each item in summary now contains "profit" from our dashboard logic
    total_profit = sum(data.get("profit", 0) for data in summary.values())
