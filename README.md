...
* **Dynamic Menu:** Automatic grid generation based on inventory data.
* **Receipt Generation:** Automatic creation of timestamped text receipts.
* **Responsive Design:** Modular frames for easy screen switching.
